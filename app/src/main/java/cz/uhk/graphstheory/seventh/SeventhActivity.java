...
public class SeventhActivity extends AbstractActivity implements TabLayoutFragment.TableLayoutCommunicationInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(v -> {
            ...
            if (isValid) {
                Toast.makeText(SeventhActivity.this, "výborně, můžeš zkusit další, nebo jít dál", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(SeventhActivity.this, "bohužel, to není správně", Toast.LENGTH_LONG).show();
            }
        });
        ...
        NavigationView navigationView = findViewById(R.id.nav_seventh);
